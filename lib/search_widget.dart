...
<g><path style="opacity:1" fill="${ColorToHex(Theme.of(context).colorScheme.primaryContainer).toHex}" d="M 460.5,252.5 C 530.363,263.83 576.196,303.497 598,371.5C 612.609,436.661 595.943,492.328 548,538.5C 582.941,489.899 593.274,436.232 579,377.5C 561.159,315.162 521.659,273.496 460.5,252.5 Z"/></g>
</svg>
