                    ...
                    return ListTile(
                      onTap: () {
                        ...
                        Navigator.push(
                            context,
                            PageTransition(
                                child: DetailsPage(personListItem),
...
<g><path style="opacity:1" fill="${ColorToHex(Theme.of(context).colorScheme.background).toHex}" d="M 405.5,216.5 C 491.354,212.171 556.854,246.171 602,318.5C 631.427,374.032 635.427,431.365 614,490.5C 584.157,559.995 531.99,601.828 457.5,616C 372.409,625.526 305.576,595.36 257,525.5C 226.615,475.685 218.281,422.351 232,365.5C 254.049,293.117 301.216,245.617 373.5,223C 384.235,220.476 394.902,218.31 405.5,216.5 Z"/></g>
<g><path style="opacity:1" fill="${ColorToHex(Theme.of(context).colorScheme.background).toHex}" d="M 460.5,252.5 C 530.363,263.83 576.196,303.497 598,371.5C 612.609,436.661 595.943,492.328 548,538.5C 582.941,489.899 593.274,436.232 579,377.5C 561.159,315.162 521.659,273.496 460.5,252.5 Z"/></g>
</svg>
'''))),
                    Center(
                      child: Text(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                        ...
                        child: Align(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(
                                fontSize: 20, fontFamily: "ScheherazadeNew"),
                          ),
                        ),
                      ),
                      title: Text(
                      ...
                      onTap: () {
                        selectedIdProvider.selectedId =
                            contactsBox.values.toList().indexOf(personListItem);
                        debugPrint(selectedIdProvider.selectedId.toString());
                        Navigator.push(
                            context,
                            PageTransition(
                                child: DetailsPage(personListItem),
