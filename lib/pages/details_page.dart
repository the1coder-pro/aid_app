          ...
          appBar: AppBar(
              ...
              actions: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    deleteDialog(context, person, box,
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      if (value != null && value == true) {
                        setState(() {
                          person = box.getAt(selectedIdProvider.selectedId)!;
                        });
...
Future<pw.Document> generatePersonRecordPdf(Person personRecord) async {
  final font = await fontFromAssetBundle('fonts/IBMPlexSansArabic-Regular.ttf');
  final boldFont =
              ...
              child: pw.Table(
                ...
                children: [
                  pw.TableRow(children: [
                    ...
                    pw.Column(children: [
                      pw.Padding(
                          child: pw.Text('رقم الهوية', style: tableHeaderStyle),
                          padding: const pw.EdgeInsets.all(4))
                    ]),
                  ]),
                  pw.TableRow(children: [
                    ...
                    pw.Column(children: [
                      pw.Padding(
                          child: pw.Text('رقم الهاتف', style: tableHeaderStyle),
                          padding: const pw.EdgeInsets.all(4))
                    ]),
                  ]),
                  pw.TableRow(children: [
                    pw.Column(children: [
                      pw.Padding(
                          child:
                              pw.Text(personRecord.aidType, style: tableStyle),
                          padding: const pw.EdgeInsets.all(4))
                    ]),
                    pw.Column(children: [
                      pw.Padding(
                          child:
                              pw.Text('نوع المساعدة', style: tableHeaderStyle),
                          padding: const pw.EdgeInsets.all(4))
                    ]),
                  ]),
                  personRecord.aidType != 'عينية' &&
                      ...
                      : pw.TableRow(children: [
                          pw.Column(children: [
                            pw.Padding(
                                child: pw.Text("${personRecord.aidTypeDetails}",
                                    style: tableStyle),
                                padding: const pw.EdgeInsets.all(4))
                          ]),
                          pw.Column(children: [
                  ...
                  pw.TableRow(children: [
                    ...
                    pw.Column(children: [
                      pw.Padding(
                          child:
                              pw.Text('مدة المساعدة', style: tableHeaderStyle),
                          padding: const pw.EdgeInsets.all(4))
                    ]),
                  ]),
                ],
