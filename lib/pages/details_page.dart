...
class _DetailsPageState extends State<DetailsPage> {
                  ...
                  delegate: SliverChildListDelegate(
                    [
                      ...
                      Card(
                        ...
                        title: Text(
                            person.idNumber == "0" || person.idNumber.isEmpty
                                ? "لا يوجد"
                                : person.idNumber),
                      ...
                      Card(
                        ...
                        title: Text(
                            isDateHijri ? hijriDateRangeView : dateRangeView),
                        onTap: () {
                          setState(() {
  ...
  IconButton deleteButton(
    ...
    return IconButton(
      ...
      onPressed: () {
        deleteDialog(context, person, hiveServiceProvider, selectedIdProvider);
      },
    );
  }
              ...
              child: AlertDialog(
                ...
                actions: [
                  ...
                  OutlinedButton(
                      ...
                      onPressed: () async {
                        if (hiveServiceProvider.people.isNotEmpty) {
                          hiveServiceProvider
