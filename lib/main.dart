                ...
                return Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        const OpenBookSVGPicture(),
                        const Center(
                          child: Text("لا توجد مساعدات مسجلة",
                              style: TextStyle(
                                  fontSize: 25, fontFamily: "ScheherazadeNew")),
                        ),
            ...
            child: Scaffold(
              ...
              body: Center(
                ...
                children: [
                  ...
                  const Center(
                    child: Text('السمات', style: TextStyle(fontSize: 20)),
                  ),
                  Center(
                    child: ToggleButtons(
...
class OpenBookSVGPicture extends StatelessWidget {
  const OpenBookSVGPicture({
    super.key,
  });
